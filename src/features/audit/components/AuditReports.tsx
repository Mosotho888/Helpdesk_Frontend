...
const ALL_ACTIONS: AuditAction[] = [
  ...
  'ROLE_CHANGED', 'PASSWORD_RESET', 'AGENT_REGISTERED', 'AVAILABILITY_CHANGED',
  'DEPARTMENT_CHANGED', 'COMMENT_ADDED', 'COMMENT_EDITED', 'COMMENT_DELETED',
  'INTERNAL_NOTE_ADDED', 'ATTACHMENT_UPLOADED', 'ATTACHMENT_DELETED', 'ATTACHMENT_DOWNLOADED',
  'ASSET_CREATED', 'ASSET_UPDATED', 'ASSET_STATUS_CHANGED', 'ASSET_ASSIGNED',
  'ASSET_RETIRED', 'ASSET_LINKED_TO_TICKET', 'ASSET_UNLINKED_FROM_TICKET', 'LOGIN_SUCCESS',
  'LOGIN_FAILED', 'ACCOUNT_LOCKED','TOKEN_REFRESHED', 'FORCED_LOGOUT',
]
